...
# there's a bug that appears here which I can't find. Whenever you empty the Global Environment and execute the code from the very beginning (The parent RMD) the following function breaks. It can't find the object, "VOTs". Explicitly defining VOTs outside of the function as a temporary measure
