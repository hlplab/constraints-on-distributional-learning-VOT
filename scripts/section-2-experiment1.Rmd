...
legend2 <- get_legend(p.trial + theme(legend.position = "top"))

grid2 <- plot_grid(
  legend1, 
  grid1,
  legend2,
  p.trial + theme(legend.position = "none", axis.title.x = element_blank()),
  ncol = 1,
  rel_heights = c(0.1, 1.1, .3, 1))
