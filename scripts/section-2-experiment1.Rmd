...
d.test.IO %<>% if (file.exists("../data/d.test.IO.rds")) {
...
```{r IO-univar-likelihood-plot, fig.width=6.5, fig.height=4.5, fig.cap="(ref:comparing-likelihoods-of-perception-data-under-each-IO)"}
