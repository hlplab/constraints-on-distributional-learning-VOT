...
IO_grid1 <- add_sub(IO_grid1, "Proportion of 't'-responses", x = -0.03, y = 2, size = 10, fontface = "bold", angle = 90)
IO_grid2 <- plot_grid(legend, IO_grid1, align = "h", ncol = 1, rel_heights = c(.08, 1))
ggdraw(IO_grid2)
```


```{r temporary-chunk-poster-plotting, warning=FALSE, fig.height=2, fig.width=8.5}
# p1 <-
#   p.IOs.VOT.no.noise +
#   theme(legend.position = "none",
#         axis.title.x = element_blank(),
