...
# TO DO: change this function to not calculate PSE OR change it to get PSE from above function
talker.VOT.no.noise <- 
...
talker.VOT_F0 %>%
  mutate(PSE = map(io, ~ get_PSE_from_io(.x)))
