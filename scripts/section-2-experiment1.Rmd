...
p.vot_trial <- p.psychometric.vot %+%
  (filter(psychometric_fit_interaction, effect2__ == 0)) +
  geom_ribbon(
    aes(ymin = lower__, 
        ymax = upper__), alpha = .08) +
