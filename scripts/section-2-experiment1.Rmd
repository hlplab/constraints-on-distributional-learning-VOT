...
```{r IO-univar-likelihood-plot, fig.width=5.5, fig.height=4.5, warning=FALSE}
...
p.likelihood <- d.test.IO %>% 
  ...
  geom_errorbar(
    ...
    position = position_dodge(.2),
    inherit.aes = F) +
  scale_y_continuous("Median likelihood per response", limits = c(0.07385, 0.073915)) +
   scale_x_discrete( 
...
```{r IO-multivar-likelihood-plot, fig.width=5.5, fig.height=3.5, warning=FALSE}
