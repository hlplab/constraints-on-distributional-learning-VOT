...
The conditions were created by first generating a baseline distribution (+0ms shift) and then shifting that distribution by +10ms and by +40ms towards the right of the VOT continuum to create the remaining two conditions. 
...
(ref:exp2-design-distribution) Histogram of all 144 exposure tokens presented over the three exposure blocks. VOT items were counter balanced over
