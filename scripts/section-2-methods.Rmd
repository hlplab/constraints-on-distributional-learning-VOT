...
Ideal observers are not, however, actual *learning* models. That is why we also pursue a second type of analysis, for which we fit a distributional learning model to participants' responses [the ideal adaptor, @kleinschmidt-jaeger2015]. This second analysis tests whether distributional learning can explain a non-trivial share of the rapid changes in speech perception that come with exposure to an unfamiliar talker. 
