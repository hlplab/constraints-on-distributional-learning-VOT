...
(ref:conditions-predicted-PSE) The expected categorization functions of the respective conditions by idealized learners who fully learn the exposure talker's phonetic distributions. The gray band marks the range of five-fold cross validated PSEs of idealized pre-exposure listeners estimated from a database of female talkers. Arrows point toward the direction of the shift of the pre-exposure PSE by an idealized learner after full exposure. Condition labels refer to the amount of shift relative to the median value of listeners' pre-exposure PSEs.
