...
d.means <- 
  ...
  mutate(
    ...
    sigma = c(80, 270, 80, 270, 80, 270), 
    mu_label = map2(category, mu, ~ bquote(mu[.(.x)]==.(.y))),
    sigma_label = map2(category, sigma, ~ bquote({sigma^2}[.(.x)]==.(round(.y, 1)))),
