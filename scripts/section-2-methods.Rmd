...
d.prior.io %>%
       ...
       fontface = "bold",
       size = 2.5) +
  scale_y_continuous("Predicted PSE (ms VOT)", limits = c(18, 68), breaks = c(25, 35, 45, 65)) +
...
```{r prior-distributions-and-exposure-conditions, fig.cap="(ref:prior-distributions-and-exposure-conditions)", fig.width=base.width*4.2, fig.height=base.height*3.5+1, fig.keep='all'}
p.placement_of_exposure_means_relative_to_prior +
