...
ggplot() +
 ...
 geom_segment(
  ...
  annotate(
       ...
       fontface = "bold",
       size = 2.5) +
  scale_y_continuous("PSE (ms VOT)", limits = c(18, 68), breaks = c(30, 40, 50, 60)) +
