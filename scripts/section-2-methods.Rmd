...
```{r prior-distributions-and-exposure-conditions, fig.width=base.width*4, fig.height=base.height*3.2+1, fig.cap="(ref:prior-distributions-and-exposure-conditions)", fig.pos="!ht"}
