...
```{r prior-distributions-and-exposure-conditions, fig.cap="(ref:prior-distributions-and-exposure-conditions)", fig.width=base.width*4.2, fig.height=base.height*3.5+1, fig.pos="!h", }
p.placement_of_exposure_means_relative_to_prior +
