...
Even less is known about prediction 4 (*learn to convergence*): despite it being a central prediction of distributional learning theories, it is not yet known whether rapid adaptation actually converges against the phonetic distributions in the input. For instance, as shown in Figure \@ref(fig:predictions)D, listeners simply *immediately switch* to entirely different mechanisms for unfamiliar speech, compared to familiar speech [e.g. "criterion relaxation", @schm@zheng-samuel2020]. Alternatively, listeners might gradually move *towards*---but never fully arrive at---the ideal categorization function that would be expected from a listener that has fully learned the exposure distributions. Such *premature convergence* against partial adaptation would raise novel questions as to whether it reflects some form of satisficing behavior, perhaps because partial adaptation is 'good enough' in achieving highly accurate speech recognition for the unfamiliar talker, or whether the mechanisms underlying rapid adaptation during speech perception are limited in the extent of adaptation they can achieve. The latter is expected, for example, if the early moments of adaptation are limited to the reweighting of previously learned dialect or sociolect representations, rather than the acquisition of new representations for the unfamiliar talkers' speech [see discussion in @kleinschmidt-jaeger2015; @wade2022; @xie2018]. We return to this reweighting hypothesis in the general discussion, as it turns out to be relevant to the present study.
...
\hline
\end{tabular}
\caption{Predictions of distributional learning models about incremental adaptation to an unfamiliar talker, and what is known about these predictions. Existing evidence is compatible with predictions 1, 2a,b, though it does not necessarily provide strong support for those predictions (see text). Prediction 3 and 4 remain untested for adaptive speech perception.}
