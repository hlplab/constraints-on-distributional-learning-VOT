...
# get io categorisations of the test points by condition
io.d.KJ16 <- 
...
# get io of typical talker and its categorisation (+0 condition)
d.typical_talker <- 
  io.d.KJ16[[2]][[1]][1, 1] %>% 
  unnest(io) %>% 
...
```{r kleinschmidt-jaeger-2016-replotted, fig.height=base.height*4.5, fig.width=base.width*4.5, fig.cap="(ref:kleinschmidt-jaeger-2016-replotted)"}
...
p.KJ16.PSE <- 
  ...
  geom_point(size = 2) +
  geom_linerange(
    aes(ymin = PSE_lower, ymax = PSE_upper), size = 1, alpha = .8) +
  scale_x_discrete("Condition") +
  scale_y_continuous("PSE") +
  theme(legend.box.just = "left") +
  labs(colour = "Condition") 

(p.KJ16.histogram / p.KJ16.result / p.KJ16.PSE) +
