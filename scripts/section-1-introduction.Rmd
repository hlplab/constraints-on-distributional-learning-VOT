...
Studies like those by Clayards and colleagues come particularly close to the standard called for by @xie2023, and they form the inspiration for the present work. Previous studies have, however, used much longer exposure than what we aim for here [an order of magnitude more than the earliest test in our study, @chladkova2017; @clayards2008; @colby2018; @escudero2011; @goudbeek2008; @goudbeek2009; @logan1991]. Next, we describe how we build on these works, including stronger joint tests of predictions 1 and 2a,b, as well as the first test of predictions 3 and 4 for adaptive speech perception. 
