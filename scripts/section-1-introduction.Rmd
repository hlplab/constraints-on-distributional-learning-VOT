...
```{r kleinschmidt-jaeger-2016-replotted, fig.height=2.5, fig.width=6.5, fig.cap="(ref:kleinschmidt-jaeger-2016-replotted)"}
...
d.KJ16 %>% 
  ...
  scale_x_continuous("VOT (msec)", breaks = seq(-30, 90, 10)) +
  facet_wrap(~ Condition.Exposure, nrow = 1)
  
  
p.KJ16 <- cond_fit_KJ16 %>% 
