...
```{r kleinschmidt-jaeger-2016-replotted, fig.cap="(ref:kleinschmidt-jaeger-2016-replotted)"}
...
d.KJ16 %<>%
  mutate(VOT_gs = (Item.VOT - VOT.mean_d.KJ16) / (2 * VOT.sd_d.KJ16))

contrasts(d.KJ16$Condition.Exposure) <- cbind(" 10vs0" = c(-3/4, 1/4, 1/4, 1/4),
                                          " 20vs10" = c(-1/2, -1/2, 1/2, 1/2),
                                          " 30vs20" = c(-1/4, -1/4, -1/4, 3/4))

write_csv(d.KJ16, "bluehive_cluster_files/data_KJ16.csv")
