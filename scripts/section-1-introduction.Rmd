...
#   ggplot() +
#   geom_hline(aes(yintercept = PSE), linetype = 1, alpha = .8, colour = "grey") +
#   geom_hline(aes(yintercept = PSE), linetype = 4, alpha = .8, colour = "#02427e") +
#   scale_y_continuous("Ideal PSE (ms VOT)", limits = c(30, 75), breaks = c(37, 72)) +
#   #scale_y_continuous("Talker") +
...
d.talker_IO.VOT %>% 
  ...
  geom_hline(data = . %>% filter(Talker == "unfamiliar"), aes(yintercept = PSE), 
             color = "#02427e", linewidth = 1.5, linetype = 4) +
  scale_y_continuous("Ideal PSE (ms VOT)", limits = c(30, 75), breaks = c(37, 72)) +
