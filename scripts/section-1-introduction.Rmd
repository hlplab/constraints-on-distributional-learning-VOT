...
```{r predictions, fig.height=base.height*3+2/3, fig.width=base.width*4.5, fig.cap="(ref:predictions)", fig.pos="H"}
d.talker_IO <- 
  get_IO_from_talkers(
...
Prediction 2b ({\bf exposure distribution}) & AA (Hitczenko \& Feldman, 2016; Xie et al., 2021; Tan et al., 2021), DL (Clayards et al., 2008; Idemaru \& Holt, 2011; Kleinschmidt \& Jaeger, 2016; Chl\'adkov\'a et al., 2017; Colby et al., 2018; Theodore \& Monto, 2019) \\
