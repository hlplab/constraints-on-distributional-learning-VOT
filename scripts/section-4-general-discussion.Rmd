...
### evidence that adaptation is cumulative and incremental
  + To the question of whether adaptation proceeds incrementally as predicted by DL models, the strength of evidence in support of this prediction depends on where the test talker's exposure distributions are placed relative to listeners' starting point. We found stronger evidence of incrementality in the +40 condition compared to the baseline and +10 conditions which were both left-shifted. Specifically, incremental adaptation was evident in +40 and +10 but less obvious in the baseline condition. 
  
+ A striking pattern of the change between blocks is a very rapid shift in categorization (between the first test after exposure and the pre-test) followed by greatly diminished incremental changes in subsequent test blocks. Most of the adaptive changes were recorded after the first exposure block. This finding is consistent with hypotheses that emphasise error-based learning [@olejarczuk2018; @harmon2019] or predictive coding [@davis-sohoglu2020] where adaptation is observed in behavioural and neural responses as a result of effort to reduce the disparity between expected stimulus and the heard stimulus. This difference between expected and actual    
