...
io.predicted.intercept <- 
  d.io.categorization %>% 
  select(Condition.Exposure, Block, intercept_scaled, PSE, Block.plot_label) %>% 
...
hyp.shrinkage <-
  hypothesis(
    ...
    c(
      str_c("abs(", "mu2_IpasteCondition.ExposureBlocksepEQxShift40x1", "- mu2_IpasteCondition.ExposureBlocksepEQxShift40x7)/ (mu2_IpasteCondition.ExposureBlocksepEQxShift40x1 - predicted PSE)" <", "abs(", d.io.categorization$intercept_scaled[[70]], "- mu2_IpasteCondition.ExposureBlocksepEQxShift10x7)"),       str_c("abs(", d.io.categorization$intercept_scaled[[70]], "- mu2_IpasteCondition.ExposureBlocksepEQxShift10x7) <", "abs(", d.io.categorization$intercept_scaled[[61]], "- mu2_IpasteCondition.ExposureBlocksepEQxShift0x7)")),
    robust = T) %>%
  .$hypothesis %>%
  dplyr::select(-Star)
