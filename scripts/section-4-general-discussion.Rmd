...
fit_test.IA_predicted_logodds <-
  brm(
    bf(
      ...
      mu1 ~ 0 + offset(0),
      mu2 ~ 1 + (Block * IA.logodds_delta) + IA.logodds_block1 +
...
fit_test.IA_predicted_logodds_intercept_slope <-
  brm(
    bf(
      ...
      mu1 ~ 0 + offset(0),
      mu2 ~ 1 + 
        Block * (IA.logodds_changes_in_intercept_across_block_condition  + IA.logodds_changes_in_slope_across_block_condition) + 
        IA.logodds_block1 +
        (1 + VOT_gs * Block | ParticipantID) + (1 + VOT_gs * Condition.Exposure * Block | Item.MinimalPair),
      theta1 ~ 1),
    data = d.IA_predicted_logodds,
