...
prior.PSE_mean <- d.io.categorization %>% 
...
d.estimates %>%
  ...
  geom_linerange(linewidth = .6, position = position_dodge(.3), alpha = .5) +
  geom_hline(
    data = d.io.categorization %>% filter(Condition.Exposure %in% c("Shift0", "Shift10", "Shift40"), Block == 7),
