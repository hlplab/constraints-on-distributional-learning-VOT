...
if (file.exists("../models/d.IA_predicted_test.csv")) {
  d.IA_predicted_test <- read_csv("../models/d.IA_predicted_test.csv")
} else {
  ...
  write_csv(d.IA_predicted_test, "../models/d.IA_predicted_test.csv")
}
