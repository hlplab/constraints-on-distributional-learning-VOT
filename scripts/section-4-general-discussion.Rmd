...
d.IA_predicted_PSE <-
  if (file.exists("../models/d.IA_predicted_PSE.csv")) {
    ...
    get_logistic_parameters_from_IBBU(m_IA_inferred.VOT_f0_vowelduration, groups = groups) %>%
      group_by(group) %>%
      median_hdci(PSE) %>%
...
### Potential explanations for premature convergence

### Potential explanations for shrinkage
