...
d.IA_predicted_exposure <-
  if (file.exists("../models/d.IA_predicted_exposure.rds")) {
...
(ref:plot-IO-human-accuracy) Mean accuracies of participants on unlabeled exposure trials (circle point ranges) against recognition accuracies of idealised learners (dashed horizontal lines) under proportional and criterion choice rules, and accuracies of fitted psychometric models (triangle point ranges). Point ranges represent the median and 95% quantile interval of participant means. Coloured dashed lines are accuracies of ideal observers trained in the respective conditions. Grey lines represent ideal observer recognition accuracy *prior* to receiving any exposure in the respective conditions.
