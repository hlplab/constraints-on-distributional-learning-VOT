...
# summarise IA fit to obtain parameters
IA_statistics <- get_exposure_statistic_from_stanfit(m_IA.VOT_f0_vowelduration_informedprior) 
```
...
if (file.exists("../models/d.IA_predicted_test_informedprior.rds")) {
  ...
  saveRDS(d.IA_predicted_test_informedprior, "../models/d.IA_predicted_informedprior.rds")
}
...
IA.prediction <-
  ...
  left_join(get_test_data_from_stanfit(m_IA.VOT_f0_vowelduration_informedprior) %>% get_untransform_function_from_stanfit(m_IA.VOT_f0_vowelduration_informedprior)(.)) %>% 
  mutate(
    Response = `/t/` / (`/d/` + `/t/`),
