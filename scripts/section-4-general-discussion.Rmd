...
fit_test.IA_predicted_logodds <-
  brm(
    ...
    file ="~/Desktop/constraints-on-distributional-learning-VOT/models/test_IA_predicted_logodds.rds",
...
fit_test.IA_predicted_logodds_intercept_slope <-
  brm(
    ...
    file ="~/Desktop/constraints-on-distributional-learning-VOT/models/test_IA_predicted_logodds_intercept_slope.rds",
    file_refit = "on_change")
```
...
fit_test.IA_predicted_logodds_nested <-
  brm(
    ...
    family = mixture(bernoulli("logit"), bernoulli("logit"), order = F),
    control = list(adapt_delta = .995), 
    file ="~/Desktop/constraints-on-distributional-learning-VOT/models/test_IA_predicted_logodds_nested.rds",
    file_refit = "on_change")
```
