...
if (file.exists("../models/d.IA_predicted_test_informedprior.rds")) {
  d.IA_predicted_test <- readRDS("../models/d.IA_predicted_test_informedprior.rds")
} else {
  ...
  saveRDS(d.IA_predicted_test, "../models/d.IA_predicted_informedprior.rds")
}

if (file.exists("../models/d.IA_predicted_PSE_informedprior.rds")) {
  d.IA_predicted_PSE <- readRDS("../models/d.IA_predicted_PSE_informedprior.rds")
} else {
