...
p2 <- human_io_accuracy %>% 
  ...
  mutate(decision = fct_relevel(decision, "human")) %>% 
  ggplot(aes(x = Block.plot_label, y = median, 
             ymin = lower, ymax = upper, 
             colour = Condition.Exposure, 
             shape = decision, 
