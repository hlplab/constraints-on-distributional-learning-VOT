...
d.IA_predicted_logodds %<>%
  mutate(
  IA.logodds_change_gs = gs_scale(., "IA.logodds_change"),
  IA.logodds_prior_gs = gs_scale(., "IA.logodds_prior"),
  IA.logodds_changes_in_intercept_across_block_condition_gs = gs_scale(., "IA.logodds_changes_in_intercept_across_block_condition"),
  IA.logodds_changes_in_slope_across_block_condition_gs = gs_scale(., "IA.logodds_changes_in_slope_across_block_condition"),
  Block_gs = gs_scale(., "Block"),
  VOT_gs = gs_scale(., "VOT"))
