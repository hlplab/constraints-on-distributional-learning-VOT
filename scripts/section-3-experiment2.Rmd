...
# run brms model of data for block 1
fit_mix_block1 <- brm(
  bf(
...
PSE.fit_mix_uniform_bias_block1 <- descale(-(summary(fit_mix_block1)$fixed["mu2_Intercept", 1] / summary(fit_mix_block1)$fixed["mu2_VOT_gs", 1]), VOT.mean_exp2, VOT.sd_exp2) 

# get posterior samples of intercept and slope, and median qi of the PSEs
post_sample_norm <- fit_mix_block1 %>% 
