...
make_hyp_table(
  ...
  c("$PSE_{-10ms} = PSE_{-20ms}$",
    ...
    "$PSE_{+20ms} = PSE_{idealized_{prior}}$",
    "$PSE_{all} = PSE_{idealized_{prior}}$"),
  ...
  pack_rows("Comparing average the PSE against idealized pre-exposure listener (Test block 1)", 7, 7)
```
