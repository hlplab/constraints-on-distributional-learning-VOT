...
p.slope_1to7 <-
  ...
  geom_hline(
    ...
    mapping = aes(yintercept = slope_unscaled),
    linetype = 2, 
    linewidth = .8, 
    colour = "grey",
    alpha = 0.5) +
