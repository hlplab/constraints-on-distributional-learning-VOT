...
With respect to incremental adaptation we found  their categorization boundaries as they received more informative exposure from the talker although the amount of shift was more straight-forwardly incremental in the +10ms condition relative to the baseline and +40ms. In the +10ms condition, listener boundaries shifted incrementally after each successive exposure block. In the +40ms condition listeners increased the shift in the third test block from the second block but then regressed slightly in test block 4 while in the baseline condition, listeners showed a slight regression in test block 3 before increasing their shift towards the implied boundary in test block 4. These mixed patterns between the conditions do not clearly tell us
