...
d.IA_predicted_PSE <- 
  if (file.exists("../data/d.IA_predictedPSE.csv")) {
    read_csv("../data/d.IA_predictedPSE.csv", show_col_types = F)
  } else {
...
write_csv(d.IA_predicted_PSE, "../data/d.IA_predictedPSE.csv")
...
p.PSE_1to7 <-     
  ...
  aes(y = PSE_median, ymin = PSE_lower, ymax = PSE_upper) +
    ...
    inherit.aes = F) +
  geom_point(
    data = d.IA_categorization,
    mapping = aes(x = Block.plot_label, y = PSE, colour = Condition.Exposure, group = Condition.Exposure),
    shape = 18,
    size = 2,
