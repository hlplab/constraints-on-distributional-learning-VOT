...
To further illustrates this point, the gray dashed line in Figure \@ref(fig:plot-fit-slope-PSE)D shows the PSE predicted by a Bayesian ideal observer trained on the distribution of VOT, f0, and vowel duration for isolated word productions in Figure \@ref(fig:exposure-means-database-matrix-plot). Following @xie2023, the ideal observers included perceptual noise [estimates taken from @kronrod2016, for details, see SI, \@ref(sec:prior-idealized-listeners)]. We emphasize that the seemingly close fit between ideal observers' predictions and listeners' behavior should not be interpreted with caution: the ideal observer predictions shown in Figure \@ref(fig:plot-fit-slope-PSE)D are based on a single phonetic database. We chose this database because it is large compared to other phonetically annotated databases, and because it contains recordings that were obtained under similar conditions as our stimuli---conditions likely to, for example, elicit some degree of hyper-articulation. It should, however, be kept in mind that the database reflects the speech of talkers recruited at a single university campus in the US, and stimuli selected to cover specific phonetic contexts rather than to be representative of a typical listener's everyday speech input. <!-- TO DO: are the points in this sentence correct? --> 
