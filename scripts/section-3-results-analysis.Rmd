...
d.estimates <-
  ...
  summarise(
    across(
      ...
      list(lower = ~ quantile(.x, probs = .025), median = ~ quantile(.x, probs = .5), upper = ~ quantile(.x, probs = .975)))) 
```
...
hyp_contrasts_nested_block_readable <- tibble(Hypothesis = c("+10 vs. baseline = 0", "+40 vs. +10 = 0", "+40 vs. baseline = 0", rep(c("+10 vs. baseline", "+40 vs. +10", "+40 vs. baseline"), 6)))
