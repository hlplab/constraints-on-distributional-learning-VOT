...
### Regression analyses
Figures \@ref(fig:plot-fit-slope-PSE)A-B summarize participants’ categorisation responses during exposure and test blocks, depending on the exposure condition and VOT.

We analyzed participants' categorisation responses during test blocks in a Bayesian mixed-effects psychometric model [e.g., @prins2012psychometric]. The psychometric model is an extension of mixed-effects logistic regression that also takes into account attentional lapses. Though we confirmed for the present case that all results would replicate in a simple mixed-effects logistic regression [@jaeger2008categorical], ignoring attentional lapses---while commonplace in research on speech perception [incl. some of our own work, but see @clayards2008perception; @kleinschmidt2016you]---can lead to biased estimates of categorization boundaries [@wichmann2001psychometric]. 
