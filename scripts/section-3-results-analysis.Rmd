...
p.PSE_1to7 <-     
  ...
  annotate(
    ...
    x = 10.05,
    y = 33.3,
    label = round(d.io.categorization$PSE[1], 2),
    size = 3,
    colour = "grey",
    fontface = "bold") +
    coord_cartesian(
...
# calculate the various mean VOTs exposed to for each condition, including the labeled trials, with and without accounting for the test trials
