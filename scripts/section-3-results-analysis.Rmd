...
```{r make-dataframe-for-logistic-regression-on-predicted-probs-by-IOs, warning=FALSE}
...
\begin{landscape}
```{r plot-fit-intercept-slope, fig.width=11.5, fig.height=3.8, warning=FALSE, fig.cap="(ref:plot-fit-intercept-slope)"}
p.fit / p.params
```
\end{landscape}
