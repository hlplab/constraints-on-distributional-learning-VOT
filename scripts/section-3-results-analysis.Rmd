...
```{r fit-nested-blocks-simple-effects}
...
hyp_interactions_readable <- tibble(Hypothesis = c(
  "10 vs baseline test 2 > 10 vs baseline test 1",
  "10 vs baseline test 3 > 10 vs baseline test 2",
  "10 vs baseline test 4 > 10 vs baseline test 3",
  "40 vs 10 test 2 > 40 vs 10 test 1",
  "40 vs 10 test 3 > 40 vs 10 test 2",
  "40 vs 10 test 4 > 40 vs 10 test 3"
))
...
hypotheses_readable <- tibble(Hypothesis = c(
  ...
  "shift in 40 vs 10 > 10 vs baseline in test 2",
  "shift in 40 vs 10 > 10 vs baseline in test 3",
  "shift in 40 vs 10 > 10 vs baseline in test 4"
))
