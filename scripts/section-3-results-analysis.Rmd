...
Additional hypothesis tests in the SI (\@ref(sec:unlearning)) show that
...
hyp_contrasts_nested_block <-
  c(
    ...
    "mu2_Block1:Condition.Exposure_Shift40vs.Shift10 + mu2_Block1:Condition.Exposure_Shift10vs.Shift0 < 4 * mu2_Block1:Condition.Exposure_Shift10vs.Shift0", # diff. between 40 and 10 is 3x 10 vs 0
    ...
    "mu2_Block3:Condition.Exposure_Shift40vs.Shift10 + mu2_Block1:Condition.Exposure_Shift10vs.Shift0 < 4 * mu2_Block1:Condition.Exposure_Shift10vs.Shift0",
    ...
    "mu2_Block5:Condition.Exposure_Shift40vs.Shift10 + mu2_Block1:Condition.Exposure_Shift10vs.Shift0 < 4 * mu2_Block1:Condition.Exposure_Shift10vs.Shift0",
    ...
    "mu2_Block7:Condition.Exposure_Shift40vs.Shift10 + mu2_Block1:Condition.Exposure_Shift10vs.Shift0 < 4 * mu2_Block1:Condition.Exposure_Shift10vs.Shift0") # shift in 40vs 10 > 10 vs 0 within test 4
...
(ref:exposure-means-database-density) Placement of exposure stimuli relative to an estimate of typical phonetic distributions for word-initial /d/ and /t/ in L1-US English [based on 92 talkers in @chodroff-wilson2018]. The outermost contour of each category shows the 95% density quantile. Points show the category means of the exposure condition, the green ellipsis shows the covariance of the +10 exposure condition (covariance was identical across conditions).
