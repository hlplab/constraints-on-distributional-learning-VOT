...
We fit two identical Bayesian mixed-effects psychometric models to participants' categorization responses on critical trials separately for test and exposure blocks [e.g., @prins2011]. Categorization at test 
