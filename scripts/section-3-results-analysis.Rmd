...
hyp_interactions_readable <- tibble(Hypothesis = c(
  "+10 vs baseline > +10 vs baseline", #  test 2 vs 1
  "+10 vs baseline  > +10 vs baseline ", # test 3 vs 2
  "+10 vs baseline test 4 > +10 vs baseline test 3", #test 4 vs test 3
  "+10 vs baseline < 0", # test 4 vs test 1 
  
  "+40 vs +10 > +40 vs +10", #test 2 vs test 1
  "+40 vs +10 > +40 vs +10", # test 3 vs test 2
  "+40 vs +10 > +40 vs +10", #test 4 vs test 3
  "+40 vs +10 < 0" # test 4 vs test 1
))
...
hyp_readable <- tibble(Hypothesis = c(
  "+10 vs baseline", 
  "+40 vs 10",
  "+40 vs baseline",
...
hyp_contrasts_within_block <- hypothesis(fit_mix_test_nested_block, hyp_contrasts_within_block)
hyp_contrasts_within_block <- hyp_contrasts_within_block$hypothesis %>% 
  select(-Star)

table2 <- cbind(hyp_readable, hyp_contrasts_within_block) %>% 
  select(-2)
...
hypothesis(fit_mix_test_nested_block, "mu2_Block1:Condition.Exposure_Shift40vs.Shift10 + mu2_Block1:Condition.Exposure_Shift10vs.Shift0 < 0")
```
