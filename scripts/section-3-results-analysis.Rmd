...
cond_means_test_exposure <- d_for_analysis %>%
  ...
  summarise(across(c(Item.VOT, Item.F0_Mel), mean, .names = "{.col}_mean_test_exposure"))
...
d_for_analysis %<>% 
  ...
  mutate(
    ...
    Item.F0_Mel_centered = case_when(
      Condition.Exposure == "Shift0" ~ Item.F0_Mel + (chodroff.mean_f0_Mel - cond_means$Item.F0_Mel_mean_exposure[1]),
      Condition.Exposure == "Shift10" ~ Item.F0_Mel + (chodroff.mean_f0_Mel - cond_means$Item.F0_Mel_mean_exposure[2]),
      Condition.Exposure == "Shift40" ~ Item.F0_Mel + (chodroff.mean_f0_Mel - cond_means$Item.F0_Mel_mean_exposure[3]))) 
