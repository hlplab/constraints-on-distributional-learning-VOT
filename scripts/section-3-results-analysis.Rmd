...
This would seem to suggest that participants learned leftward shifts along the VOT continuum more slowly or less well, which would explain why the categorization functions of participants in the baseline condition changed very little after the first exposure block (see also Table \@ref(tab:hypothesis-table-simple-effects-block)): participants in this condition shifted their categorization functions as much as they could after a single block of exposure. This would explain why the distance between the +10 and baseline conditions decreases over the subsequent blocks, as discussed above. In contrast, participants in the +40 condition exhibited more substantial changes in their PSEs until at least Test 3. Even for this exposure condition, however, a visual inspection of Figure \@ref(fig:plot-fit-PSE)C seems to suggest that changes in listeners' PSE might be 'leveling off' after Test 3. In the general discussion, we return to this suggestive trend in our data, and ask what it would imply for theories of adaptive speech perception, if replicated in future work. Before we do so, we briefly summarize the effects of repeated testing.
