...
fit_mix_test <-
  brm(
    ...
    file = "../models/test-standard-priorSD10-0.99.rds")
...
fit_mix_exposure <-
  update(
    ...
    newdata = d_for_analysis %>%
      ...
      prepVars(levels.Condition = levels_Condition.Exposure, contrast_type = contrast_type),
    file = "../models/exposure-standard-priorSD10-0.999.rds")
```
...
fit_mix_test_nested <-
  brm(
    ...
    family = mixture(bernoulli("logit"), bernoulli("logit"), order = F),
    control = list(adapt_delta = .99),
    file = "../models/test-nested_slope-priorSD10-0.99.rds")
...
fit_mix_exposure_nested <-
  update(
    ...
    newdata = d_for_analysis %>%
      ...
      prepVars(levels.Condition = levels_Condition.Exposure, contrast_type = "difference"),
    file = "../models/exposure-nested_slope-priorSD10-0.999.rds")
