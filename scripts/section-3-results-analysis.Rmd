...
d.chodroff_wilson %>%
  ...
  facet_matrix(vars(c(VOT, f0_Mel, vowel_duration)), layer.lower = c(3, 4:5), layer.diag = 2,
               layer.upper = c(1, 4:5),
               labeller = labeller(.rows = c(VOT = "VOT (ms)", f0_Mel = "f0 (Mel)", vowel_duration = "Vowel duration (ms)"),
