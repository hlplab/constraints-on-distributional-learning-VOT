...
Consistent with the trend observed in test blocks, categorization boundaries were clearly distinct between the conditions in all exposure blocks and grew progressively larger with more exposure. Evidence for the effect was stronger in the +40 vs. +10 comparison ($24.7 \leq$ BFs $\leq 100.3$) with the difference in PSE reaching its widest in the final exposure block (BF = 91). The difference between +10 and baseline widened from the exposure block 1 to 2 but narrowed in the final block where evidence in support of the difference also fell substantially (BF = 11.4). The weaker effects of exposure condition in this comparison reflect the pattern in test blocks. 
