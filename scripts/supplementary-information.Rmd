...
bf_f0 <-  
  bf(f0_Mel_gs | trunc(lb = 200) ~ 0 + category + (0 + category | p | Talker)) + 
  lf(sigma  | trunc(lb = 200) ~ 0 + category + (0 + category | p | Talker)) +
  brmsfamily(
    "gaussian", 
    link = "identity", 
    link_sigma = "log")
...
bf_vowel_duration <-  
  bf(vowel_duration_gs ~ 0 + category + (0 + category | p | Talker)) + 
  lf(sigma ~ 0 + category + (0 + category | p | Talker)) +
  lf(alpha ~ 0 + category + (0 + category | p | Talker)) + 
  brmsfamily(
    "skew_normal", 
...
saveRDS(DMMM, file = "../models/DMMM-attempt1")
```
