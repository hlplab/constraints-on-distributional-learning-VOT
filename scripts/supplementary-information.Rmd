...
## Test blocks
### Differences in block to block changes across conditions
In the main text, we refer to differences in the rate of block to block changes across exposure conditions. These differences correspond to the interactions between exposure conditions and block in the psychometric mixed-effect model. These interactions are summarized in Table \@ref(tab:hypothesis-table-interactions)
...
## Can assumptions of our analyses explain differences between exposure and test blocks? {sec:exposure-test-zigzag}
