...
```{r}
filename <- "../models/best_performing_parameters.normalization.rds"
...
```{r}
filename <- "../models/best_performing_parameters.decision_making.rds"
...
if (RESET_MODELS || !file.exists(filename)) {
  ...
  saveRDS(best_performing_parameters.bias, filename)
} else {
  best_performing_parameters.bias <- readRDS(filename)
}
