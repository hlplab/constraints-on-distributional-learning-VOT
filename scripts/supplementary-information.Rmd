...
### Regression analysis - model selection (norming)
...
if (file.exists("../models/conditional_effects_fit_mix_f0.rds")){
  fit_mix_f0_data <- read_rds("../models/conditional_effects_fit_mix_f0.rds")
} else {
  int_conditions <- list(sTrial = sort(unique((d.test.excluded$Trial - Trial.mean)) / (2 * Trial.sd)))
