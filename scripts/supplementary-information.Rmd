...
```{r hypothesis-table-interactions, results='asis', fig.cap="TEMPORARY PLACEMENT OF THIS TABLE. TO BE MOVED TO SI WHEN DISCUSSION IS COMPLETE"}
...
hyp_interactions <- hypothesis(fit_test, hyp_interactions, robust = T)
