...
# Move into functions file later
...
d_for_ASP <- 
  ...
  mutate(
    ...
    x = map2(Item.VOT, Item.F0_target_for_generation_script, ~ c(.x, .y)),
  ...
  select(ExposureGroup, Phase, ParticipantID, Block, Trial, x, Response.Category, Item.ExpectedResponse)
```
