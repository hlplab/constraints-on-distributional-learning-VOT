...
# conservative here since we're creating ideal observers below that are averaging 
# across talkers, and so we'd like to make sure that each talker-specific IO is 
...
n_distinct(d.chodroff_wilson$Talker)
