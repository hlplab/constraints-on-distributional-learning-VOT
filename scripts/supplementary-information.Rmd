...
The document was compiled using \texttt{knitr} in RStudio with R:
...
Of the 122 participants, 1 committed more than 3 errors (< 84% accuracy).
Labelled trials provided another measure to check participant attention during the experiment. Performance on labelled trials was good across all exposure conditions with participants in the +40 condition committing the most errors. This is not unexpected as the +40 condition had the furthest shifted with the most unexpected cue-category mappings. 


(ref:plot-catch-labeled-trial-performance) Performance of catch and labelled trials. 
...
### Analysis of lapse rates {#sec:analysis-lapse}
...
## Exposure blocks {#sec:SI-exposure-block-analysis}
